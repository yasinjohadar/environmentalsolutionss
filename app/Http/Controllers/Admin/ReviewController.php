...
class ReviewController extends Controller
{
    ...
    {
        $reviewsQuery = Review::with(['product', 'user'])->latest();
    ...
    {
        $review = Review::with(['product', 'user', 'adminResponder', 'interactions.user', 'replies.user'])
            ->findOrFail($id);
    ...
    public function statistics()
    {
        ...
        $topRatedProducts = Product::withCount(['reviews' => function($query) {
            $query->approved();
        }])
