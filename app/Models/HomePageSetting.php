    ...
    public static function defaultContent(): array
    {
        ...
        return [
            ...
            'choose_us' => [
                ...
                'mission' => [
                    'text' => 'نسعى إلى معالجة أزمة النفايات الإلكترونية من خلال إنشاء آلية منظمة وآمنة للجمع والمعالجة، والحد من المخاطر البيئية والصحية، مع تحويل الأجهزة التالفة إلى موارد تعليمية وتقنية تخدم المجتمع.',
                ],
                'approach' => [
                    'text' => 'نعتمد نهجًا متكاملًا يقوم على الجمع المنظم، الفرز والتفكيك الآمن، إعادة التأهيل وإعادة الاستخدام قبل إعادة التدوير، مع الالتزام بمعايير السلامة المهنية وحماية البيانات، مدعومًا بنظام إدارة رقمي يضمن الشفافية والكفاءة.',
                ],
                'vision' => [
                    'text' => 'نطمح إلى مستقبلٍ تتحول فيه النفايات الإلكترونية من عبء بيئي إلى فرصة للتعلّم والابتكار والتنمية المستدامة، وأن يكون المشروع نموذجًا قابلًا للتوسّع محليًا وإقليميًا.',
                ],
            ],
            'portfolio' => [
