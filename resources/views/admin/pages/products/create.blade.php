    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            <div class="page-header d-flex justify-content-between align-items-center my-4">
                <h5 class="page-title mb-0">إضافة منتج جديد</h5>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('wholesale_price') is-invalid @enderror" 
                                               name="wholesale_price" value="{{ old('wholesale_price') }}" min="0">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control @error('min_order_quantity') is-invalid @enderror" 
                                               name="min_order_quantity" value="{{ old('min_order_quantity', 1) }}" min="1">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div id="variants-container">
                                    <!-- سيتم إضافة التباينات ديناميكياً -->
                                </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <input type="file" class="form-control @error('main_image') is-invalid @enderror" 
                                       name="main_image" accept="image/*" onchange="previewImage(this, 'main-image-preview')">
                                <img id="main-image-preview" class="image-preview" style="display: none;" alt="معاينة الصورة الرئيسية">
                                @error('main_image')
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control @error('dimensions') is-invalid @enderror" 
                                           name="dimensions" value="{{ old('dimensions') }}" placeholder="مثال: 10×20×30">
                                    @error('dimensions')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('meta_keywords') is-invalid @enderror" 
                                           name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="افصل بين الكلمات بفواصل">
                                    @error('meta_keywords')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="file" class="form-control @error('og_image') is-invalid @enderror" 
                                           name="og_image" accept="image/*" onchange="previewImage(this, 'og-image-preview')">
                                    <img id="og-image-preview" class="image-preview" style="display: none;" alt="معاينة صورة OG">
                                    @error('og_image')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
...
@section('script')
    <script>
        ...
        // Add variant (سيتم تطويره لاحقاً)
