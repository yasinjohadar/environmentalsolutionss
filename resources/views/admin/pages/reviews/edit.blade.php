                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('client_name') is-invalid @enderror" 
                                               name="client_name" value="{{ old('client_name', $review->client_name) }}" placeholder="للعرض في الشهادات">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('client_title') is-invalid @enderror" 
                                               name="client_title" value="{{ old('client_title', $review->client_title) }}" placeholder="مثال: مدير مؤسسة">
