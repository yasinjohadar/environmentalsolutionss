                            ...
                            <div class="flex-shrink-0 ms-auto">
                                <form action="{{ route('admin.reviews.index') }}" method="GET" class="d-flex align-items-center gap-2">
                                    <input style="width: 250px" type="text" name="query" class="form-control" 
                                        placeholder="بحث بالمنتج، المستخدم أو التعليق" value="{{ request('query') }}">

                                    <select name="product_id" class="form-select" style="width: 180px">
                                ...
                                <table class="table table-striped table-hover align-middle table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th scope="col" style="min-width: 200px;">المنتج</th>
