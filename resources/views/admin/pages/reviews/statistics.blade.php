        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title mb-0">أكثر المنتجات تقييماً</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @forelse($topRatedProducts as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="text-warning">{{ str_repeat('★', round($product->reviews_avg_rating ?? 0)) }}</span>
                                                    <span class="text-muted">{{ str_repeat('☆', 5 - round($product->reviews_avg_rating ?? 0)) }}</span>
                                                    <span class="ms-2">({{ number_format($product->reviews_avg_rating ?? 0, 1) }}/5)</span>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center">لا توجد آراء</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
