                            ...
                            <div class="card-body p-0 customers mt-1">
                                <div class="list-group list-lg-group list-group-flush">
                                    <div class="list-group-item list-group-item-action">
                                        <div class="d-flex">
                                            <svg class="avatar avatar-md rounded-circle my-auto me-3" width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="20" cy="20" r="20" fill="#f59e0b"/>
                                                <text x="20" y="26" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="white" text-anchor="middle">S</text>
                                            </svg>
                                    ...
                                    <div class="list-group-item list-group-item-action br-t-1">
                                        <div class="d-flex">
                                            <svg class="avatar avatar-md rounded-circle my-auto me-3" width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <text x="20" y="26" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="white" text-anchor="middle">J</text>
                                            </svg>
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="mt-1">
                                    ...
                                    <div class="list-group-item list-group-item-action br-t-1">
                                        <div class="d-flex">
                                            <svg class="avatar avatar-md rounded-circle my-auto me-3" width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <text x="20" y="26" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="white" text-anchor="middle">G</text>
                                            </svg>
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="mt-1">
                                    ...
                                    <div class="list-group-item list-group-item-action br-t-1">
                                        <div class="d-flex">
                                            <svg class="avatar avatar-md rounded-circle my-auto me-3" width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <text x="20" y="26" font-family="Arial, sans-serif" font-size="14" font-weight="bold" fill="white" text-anchor="middle">M</text>
                                            </svg>
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="mt-1">
