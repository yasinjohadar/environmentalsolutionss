        ...
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div>
                    ...
                    <p class="mb-0 text-muted">إضافة عضو لقسم الفريق في الصفحة الرئيسية</p>
                </div>
                <div class="ms-auto">
                        ...
                        <div class="card custom-card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="مثال: مدير قسم الاستدامة" required>
                                    @error('title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card custom-card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">اختياري - يفضل صورة مربعة 306x306</small>
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card custom-card mb-4">
                            <div class="card-body">
                                ...
                                <button type="submit" class="btn btn-primary w-100 mb-2">
                                    <i class="bi bi-save me-2"></i>حفظ العضو
                                </button>
