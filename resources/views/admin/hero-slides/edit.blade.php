        ...
        <div class="container-fluid">
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div>
                    ...
                    <p class="mb-0 text-muted">تعديل شريحة قسم الهيرو</p>
                </div>
                <div class="ms-auto">
                        ...
                        <div class="card custom-card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="subtitle" class="form-control @error('subtitle') is-invalid @enderror" value="{{ old('subtitle', $heroSlide->subtitle) }}">
                                    @error('subtitle')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $heroSlide->title) }}" required>
                                    @error('title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror">{{ old('description', $heroSlide->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="button1_text" class="form-control" value="{{ old('button1_text', $heroSlide->button1_text) }}">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">رابط الزر الأول</label>
                                        <input type="text" name="button1_url" class="form-control" value="{{ old('button1_url', $heroSlide->button1_url) }}" placeholder="/project أو https://...">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="button2_url" class="form-control" value="{{ old('button2_url', $heroSlide->button2_url) }}" placeholder="/about أو https://...">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                @if($heroSlide->background_image)
                                    <div class="mb-3">
                                        ...
                                        <img src="{{ $heroSlide->background_image_url }}" alt="" class="img-fluid rounded d-block mb-2" style="max-height: 150px;">
                                    </div>
                                @endif
                        ...
                        <div class="card custom-card mb-4">
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="order" class="form-control" value="{{ old('order', $heroSlide->order) }}" min="0">
                                </div>

                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" name="is_active" value="1" id="is_active" {{ old('is_active', $heroSlide->is_active) ? 'checked' : '' }}>
