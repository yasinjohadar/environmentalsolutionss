...
<body class="body-white bg-white">
    ...
    <section class="homeCone-footer bg-title position-relative py-80">
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6">
                    <p class="text-white mb-0">جميع الحقوق محفوظة</p>
                </div>
                <div class="col-lg-6 text-lg-end">
                    <a href="{{ route('home') }}" class="text-white me-3">الرئيسية</a>
                    <a href="{{ route('frontend.blog.index') }}" class="text-white me-3">المدونة</a>
                    <a href="contact.html" class="text-white">اتصل بنا</a>
                </div>
            </div>
        </div>
    </section>

    <div class="scroll-top"><svg class="progress-circle svg-content" width="100%" height="100%" viewBox="-1 -1 102 102"><path d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98"/></svg></div>
